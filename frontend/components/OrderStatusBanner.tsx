...
export function OrderStatusBanner() {
    ...
    return (
        <div className="px-4 pt-4">
            <div className="rounded-2xl bg-gradient-to-r from-emerald-50 to-emerald-100 border border-emerald-200 p-4 shadow-sm animate-pulse-subtle relative transform transition-all duration-300 ease-in-out">
